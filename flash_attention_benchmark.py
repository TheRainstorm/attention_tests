...
# @pytest.mark.parametrize("seqlen", [128, 2000, 4000, 32000])
# @pytest.mark.parametrize("batch_size", [16])
# @pytest.mark.parametrize("nheads_q", [32])
# @pytest.mark.parametrize("nheads_kv", [32])
@pytest.mark.parametrize("seqlen", [1024, 2048, 4096, 8192, 16384])
@pytest.mark.parametrize("batch_size", [128])
@pytest.mark.parametrize("nheads_q", [16])
@pytest.mark.parametrize("nheads_kv", [128])
...
@pytest.mark.parametrize("use_bench_cudagraph", [True])
...
def test_attention_benchmark(
    ...
    print(f"\n{batch_size=}, {seqlen=}, {seqlen_q=}, {nheads_q=}, {nheads_kv=}, {headdim=}, {headdim_v=}, {page_size=}, {use_bench_cudagraph=}, {num_splits=}, {has_qv=}")
    ...
    ideal_h20_time_mem = mem_io / 4e12 * 1e6
    ideal_h20_time_flop = flops / 148e12 * 1e6
    ideal_a800_time_mem = mem_io / 1.935e12 * 1e6
    ideal_a800_time_flop = flops / 312e12 * 1e6
    ...
    print(f"{ideal_h100_time_mem=:.0f} us")
    print(f"{ideal_h100_time_flop=:.0f} us")
    # print(f"{ideal_h20_time_mem=:.0f} us")
    # print(f"{ideal_h20_time_flop=:.0f} us")
    # print(f"{ideal_a800_time_mem=:.0f} us")
    # print(f"{ideal_a800_time_flop=:.0f} us")
...
if __name__ == "__main__":
    ...
    # for attn_variant in attn_variants[0:2]:
    for attn_variant in attn_variants[1:2]:
    # for attn_variant in attn_variants[3:5]:
        ...
        # for seqlen in [128, 2000, 4000, 32000]:
